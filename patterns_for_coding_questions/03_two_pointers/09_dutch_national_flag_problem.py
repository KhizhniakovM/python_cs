...
# Let’s say the two pointers are called low and high which are pointing to the first and the last element
# of the array respectively. So while iterating, we will move all 0s before low and all 2s after high so that in the end,
