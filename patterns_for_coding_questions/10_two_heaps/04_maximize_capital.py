...
# among the projects for which we have enough capital, which gives us a maximum profit.
...
#    capital requirement.
# 2. Go through the top projects of the min-heap and filter the projects
#    that can be completed within our available capital.
#    Insert the profits of all these projects into a max-heap,
...
# because we will be storing all the projects in the heaps.
