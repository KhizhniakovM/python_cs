...
# To efficiently solve this problem, we can use the fact that the input array contains numbers 
# in the range of 1 to n. For example, to efficiently sort the array, we can try placing each 
# number at its correct place, i.e., placing 1 at index '0', placing 2 at index ‘1’, and so on. 
# Once we are done with the sorting, we can iterate the array to find all indices 
