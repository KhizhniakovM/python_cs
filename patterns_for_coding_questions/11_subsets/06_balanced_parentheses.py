...
# - To keep the parentheses balanced, we can add a close parenthesis ) only when we have already
...
# 2. At every step, let’s take all combinations of the previous step and add ( or )
...
#    We can’t add ) as we don’t have an equivalent open parenthesis,
#    so our list of combinations will now be: “(”
# 4. For the next iteration, let’s take all combinations of the previous set.
#    For “(” we can add another ( to it since the count of open parenthesis will be less than ‘N’.
#    We can also add ) as we do have an equivalent open parenthesis,
#    so our list of combinations will be: “((”, “()”
# 5. In the next iteration, for the first combination “((”, we can add another ( to
#    it as the count of open parenthesis will be less than ‘N’, we can also add )
#    as we do have an equivalent open parenthesis.
#    This gives us two new combinations: “(((” and “(()”.
#    For the second combination “()”, we can add another ( to it since the count of open
#    parenthesis will be less than ‘N’. We can’t add ) as we don’t have an equivalent open parenthesis,
#    so our list of combinations will be: “(((”, “(()”, ()("
