...
# however, some forethought into the design can save valuable time and resources in the future.
# In the following chapters, we will try to define some of the core building
...
# Consistent Hashing, CAP Theorem, Load Balancing, Caching, Data Partitioning, Indexes,
# Proxies, Queues, Replication, and choosing between SQL vs. NoSQL.
