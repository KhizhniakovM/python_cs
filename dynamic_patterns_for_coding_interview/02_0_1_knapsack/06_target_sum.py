...
# either a ‘+’ or ‘-’ sign. We need to find out total ways to assign symbols to make the sum of
...
# Now, let’s say ‘Sum(s1)’ denotes the total sum of set ‘s1’, and ‘Sum(s2)’ denotes the total sum
# of set ‘s2’. So the required equation is:
...
def find_target_subsets_space(num, s):
    ...
    return count_subsets_space(num, int((s + totalSum) / 2))


# this function is exactly similar to what we have in 'Count of Subset Sum' problem
def count_subsets_space(num, sum):
    n = len(num)
