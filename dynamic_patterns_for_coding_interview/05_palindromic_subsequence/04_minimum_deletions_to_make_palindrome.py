...
# * MARK: - Solution
# This problem can be easily converted to the Longest Palindromic Subsequence (LPS) problem. We can use the fact
# that LPS is the best subsequence we can have, so any character that is not part of LPS must be removed.
...
# Input: = "pqr"
# Output: 2
# Explanation: We have to insert any two characters to get a palindrome (e.g. if we insert “pq”,
# we get a palindrome “pqrqp”).
...
# This problem can easily be converted to our base problem of finding the minimum deletions in a string
# to make it a palindrome. If the “minimum deletion count” is not more than ‘K’, the string will be K-Palindromic.
