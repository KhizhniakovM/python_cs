...
# Amazon (amazon.com) is the world’s largest online retailer. The company was originally a bookseller
# but has expanded to sell a wide variety of consumer goods and digital media. For the sake of this problem,
# we will focus on their online retail business where users can sell/buy their products.

# * MARK: - Requirements and Goals of the System
...
# - Member: Members can perform all the activities that guests can, in addition to which, they can place orders and add
...
# ShoppingCart, Item, Order, and OrderLog: Users will add items to the shopping cart and place an order
# to buy all the items in the cart.
