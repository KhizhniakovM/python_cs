...
# with same Letters after Replacement. The only difference is that, in the problem,
...
# So at any time, we know that we can have a window with 1s repeating maxOnesCount time,
