...
# the node values of the first half in the forward direction should be similar to the
# node values of the second half in the backward direction.
...
# 4. Finally, we will reverse the second half of the LinkedList again to revert and bring
#    the LinkedList back to its original form.
