...
# This pattern defines an easy way to understand the technique 
# for performing topological sorting of a set of elements and then solves a few problems using it.
