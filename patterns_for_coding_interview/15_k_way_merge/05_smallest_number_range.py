...
# has the largest element that we inserted in the heap. If these two numbers give us a
# smaller range, we’ll update our range. Finally, if the array of the top element has
...
# algorithm will be O(N*logM) where ‘N’ is the total number of elements in all the ‘M’ input arrays.
