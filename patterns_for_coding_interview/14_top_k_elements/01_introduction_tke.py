# Introduction
# Any problem that asks us to find the top/smallest/frequent ‘K’ elements among
# a given set falls under this pattern.
...
# elements at a time from a set of given elements.
