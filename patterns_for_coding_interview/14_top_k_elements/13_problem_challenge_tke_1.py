...
# The only difference is that in the ‘Rearrange String’ the same characters need not
# be adjacent i.e., they should be at least ‘2’ distance apart (in other words, there
# should be at least one character between two same characters), while in the current problem,
...
# in the next iteration, in this problem, we will re-insert the character after ‘K’
# iterations. We can keep track of previous characters in a queue to insert them back
