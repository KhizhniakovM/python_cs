...
# First, we will find the frequencies of all characters, then use a max-heap to find
# the most occurring characters.
...
# where ‘D’ is the number of distinct characters in the input string. This means,
# in the worst case, when all characters are unique the time complexity of the algorithm will be O(N*logN)
# where ‘N’ is the total number of characters in the string.

# * MARK: - Space Complexity
# The space complexity will be O(N), as in the worst case,
