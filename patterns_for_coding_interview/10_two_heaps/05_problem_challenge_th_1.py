...
# intervals to find the next interval. This algorithm will take O(N^2) where N
...
# 2. Find an interval in the maxStartHeap with the closest start greater than or equal
#    to the start of topEnd. Since maxStartHeap is sorted by ‘start’ of intervals,
#    it is easy to find the interval with the highest ‘start’. Let’s call this interval topStart.
# 3. Add the index of topStart in the result array as the next interval of topEnd.
...
# The time complexity of our algorithm will be O(NlogN), where N
# is the total number of intervals.

# * MARK: - Space Complexity
# The space complexity will be O(N)
# because we will be storing all the intervals in the heaps.
