...
# This means, in each iteration, when we insert a new number in the heaps,
# we need to remove one number from the heaps which is going out of the sliding window.
