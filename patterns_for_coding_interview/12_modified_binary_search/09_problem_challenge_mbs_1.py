...
# decreasing. Monotonically increasing or decreasing means that for any index i in the array
# arr[i] != arr[i+1].
...
# 1. First, we can find the index of the maximum value of the bitonic array,
...
# 3. We can then call Binary Search separately in these two arrays to search the ‘key’.
