...
# 1. When trying to find the first position of the ‘key’, we can update end = middle - 1 to
#    see if the key is present before middle.
# 2. When trying to find the last position of the ‘key’, we can update start = middle + 1 to
#    see if the key is present after middle.
