...
# The ceiling of the ‘key’ will be the smallest element in the given array greater than or equal
# to the ‘key’.
...
# the next big number will be pointed out by the index start. Consider Example-2 mentioned above:
# ../images/12_modified_binary_search/002.png

# Since we are always adjusting our range to find the ‘key’, when we exit the loop,
# the start of our range will point to the smallest number greater than the ‘key’
# as shown in the above picture.

# We can add a check in the beginning to see if the ‘key’ is bigger than the biggest
# number in the input array. If so, we can return ‘-1’.
