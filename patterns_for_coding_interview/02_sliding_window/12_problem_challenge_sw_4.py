...
# Maximum Sum Subarray of Size K. We will keep track of all the words in a HashMap and try to
# match them in the given string. Here are the set of steps for our algorithm:

# 1. Keep the frequency of every word in a HashMap.
# 2. Starting from every index in the string, try to match all the words.
# 3. In each iteration, keep track of all the words that we have already seen in another HashMap.
# 4. If a word is not found or has a higher frequency than required, we can move on to the next character
# in the string.
