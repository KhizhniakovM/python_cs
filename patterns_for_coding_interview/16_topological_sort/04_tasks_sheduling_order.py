...
# tasks which need to be completed before it can be scheduled. Given the number of
# tasks and a list of prerequisite pairs, write a method to find the ordering of
...
# * MARK: - Solution
# This problem is similar to Tasks Scheduling, the only difference being that we
# need to find the best ordering of tasks so that it is possible to schedule them all.
