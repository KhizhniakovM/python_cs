...
# * MARK: - Solution
# This problem is similar to Tasks Scheduling Order, the only difference is that
...
# therefore, in this case, we will have multiple orderings of the tasks. We can use a
# recursive approach with Backtracking to consider all sources at any step.
...
# If we don’t have any prerequisites, all combinations of the tasks can represent a topological
