...
# Given that the input array is sorted, an efficient way would be to start with one pointer in 
# the beginning and another pointer at the end. At every step, we will see if the numbers pointed by 
# the two pointers add up to the target sum. If they do not, we will do one of two things:
...
# images/03_two_pointers/001.png
