...
# 2. Starting from the end of the array the first number out of the sorting order is ‘0’ as it is bigger
#    than its previous element which is ‘-1’
...
# The problem here is that the smallest number of our subarray is ‘-1’ which dictates that we need to
# include more numbers from the beginning of the array to make the whole array sorted.
