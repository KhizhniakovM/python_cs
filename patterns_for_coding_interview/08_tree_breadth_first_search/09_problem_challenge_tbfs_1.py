...
# We can follow the same BFS approach. The only difference will be that while traversing we will
# remember (irrespective of the level) the previous node to connect it with the current node.
