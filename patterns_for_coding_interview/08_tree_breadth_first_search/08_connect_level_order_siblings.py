...
# We can follow the same BFS approach. The only difference is that while traversing a level
# we will remember the previous node to connect it with the current node.
