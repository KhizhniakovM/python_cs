...
# We can follow the same BFS approach. The only additional step we have to keep in mind is
# to alternate the level order traversal, which means that for every other level,
