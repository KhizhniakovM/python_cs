...
# If one racer is faster than the other, the faster racer is bound to catch up and cross
# the slower racer from behind. We can use this fact to devise an algorithm to determine
...
#    the LinkedList before the slow pointer to reveal that there is no cycle in the LinkedList.
