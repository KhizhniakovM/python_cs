...
# such that the nodes from the second half of the LinkedList are inserted alternately to
...
# 1. We can use the Fast & Slow pointers method similar to Middle of the LinkedList to
...
# 3. Finally, we’ll iterate through the first half and the reversed second half to
#    produce a LinkedList in the required order.
