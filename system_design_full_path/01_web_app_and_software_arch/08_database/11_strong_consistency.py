...
# all the server nodes across the world should contain the same value of an entity at any point in time. The only way to implement this behavior is by locking down the nodes as they are being updated.
...
# system_design_full_path/images/048.png
...
# Well, this is pretty much it for strong consistency. Now, let’s look into the CAP theorem in the lesson up next.
